...
class MAIN:
    ...
    def check_fail(self):
        if not 0 <= self.snake.body[0].x < cell_number or not 0 <= self.snake.body[1].y < cell_number:
            self.game_over()
    ...
    def draw_score(self):
        ...
        score_rect = score_surface.get_react(center =(score_x,score_y))
